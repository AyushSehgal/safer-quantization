#!/bin/bash
#SBATCH --job-name=amplify_standard
#SBATCH --output=logs/amplify/amplify_standard_%j.out
#SBATCH --error=logs/amplify/amplify_standard_%j.err
...
# ── W8A8 ───────────────────────────────────────────────────────────────────────
echo "============================================================"
echo "  [1/2] Standard eval — W8A8 (int8)  layers=${LAYERS}"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "  [2/2] Standard eval — W4A16 (int4)  layers=${LAYERS}"
echo "============================================================"
