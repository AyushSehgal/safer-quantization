...
def main():
    ...
    parser.add_argument("--use_refusal_dir", default=False, action="store_true",
                        help="Replace SLR probe with per-layer refusal direction (difference-in-means). "
                             "Requires refusal_dirs/{net}.pt generated by extract_refusal_directions.py")
    ...
    omniquant(
        ...
        act_shifts,
        logger,
        use_refusal_dir=args.use_refusal_dir,
    )
