...
def main():
    ...
    parser.add_argument("--refusal_weight_mu", type=float, default=0.01,
                        help="Weight for the refusal-direction weight-space regularizer in 'combined' mode.")
    ...
    omniquant(
        ...
        refusal_weight_mu=args.refusal_weight_mu,
    )
